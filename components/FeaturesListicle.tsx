      ...
      <div className="max-w-3xl mx-auto">
        <div className="bg-base-100 max-md:px-8 max-w-3xl">
          ...
          <div className="text-base-content/80 leading-relaxed mb-8 lg:text-lg">
            ...
            Stop wasting hours searching for learning resources. Get AI-curated
            learning paths with verified resources organized by skill level.
            ViaProto provides you with a clear roadmap to master any skill, FAST.
          </div>
        </div>
      </div>
