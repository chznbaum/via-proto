...
**Generated:** 2025-11-22T22:17:29.461Z
...
### ArchiCAD
- **Slug:** `archicad`
- **Synonyms:** ArchiCAD by Graphisoft
- **Alternatives:**
  - `revit` (similar)
...
### Fusion 360
- **Slug:** `fusion-360`
- **Synonyms:** Autodesk Fusion 360

### Revit
- **Slug:** `revit`
- **Synonyms:** Autodesk Revit

### Rhino
- **Slug:** `rhino`
- **Synonyms:** Rhino 3D, Rhinoceros

### SketchUp
- **Slug:** `sketchup`
- **Synonyms:** SketchUp Pro
...
- **Alternatives:**
  - `docker-hub` (similar)
  - `azure-container-registry` (similar)
...
- **Alternatives:**
  ...
  - `azure-container-instances` (similar)
...
- **Alternatives:**
  - `aws-ecr` (similar)
  - `google-container-registry` (similar)
...
- **Alternatives:**
  - `harbor` (similar)
  - `github-container-registry` (similar)
...
- **Alternatives:**
  - `google-artifact-registry` (similar)
  - `aws-ecr` (similar)
...
- **Synonyms:** Illustrator, AI
- **Alternatives:**
  - `affinity-designer` (similar)
  - `inkscape` (similar)
...
- **Synonyms:** InDesign, ID
- **Alternatives:**
  - `affinity-publisher` (similar)

### Adobe Photoshop
- **Slug:** `adobe-photoshop`
- **Icon:** `logos:adobe-photoshop`
- **Synonyms:** Photoshop, PS
- **Alternatives:**
  - `affinity-photo` (similar)
  - `gimp` (similar)
...
- **Slug:** `gimp`
- **Icon:** `devicon:gimp`
- **Synonyms:** GNU Image Manipulation Program
- **Alternatives:**
  - `adobe-photoshop` (similar)
...
### 3ds Max
- **Slug:** `3ds-max`
- **Icon:** `devicon:threedsmax`
- **Synonyms:** 3D Studio Max, Autodesk 3ds Max
- **Alternatives:**
  - `blender` (similar)
  - `maya` (similar)
...
- **Synonyms:** Animate, Flash Professional

### Adobe Premiere Pro
- **Slug:** `adobe-premiere-pro`
- **Icon:** `logos:adobe-premiere`
- **Synonyms:** Premiere Pro, Premiere, PPro
...
- **Synonyms:** DaVinci, Resolve
- **Alternatives:**
  - `adobe-premiere-pro` (similar)
...
- **Alternatives:**
  - `adobe-premiere-pro` (similar)
  - `davinci-resolve` (similar)

### Houdini
- **Slug:** `houdini`
- **Synonyms:** SideFX Houdini
- **Alternatives:**
  - `blender` (similar)
...
- **Synonyms:** Adobe Substance Designer

### Substance Painter
- **Slug:** `substance-painter`
- **Synonyms:** Adobe Substance Painter

### Toon Boom Harmony
- **Slug:** `toon-boom-harmony`
- **Synonyms:** Toon Boom, Harmony
- **Alternatives:**
  - `adobe-animate` (similar)

### V-Ray
- **Slug:** `vray`
- **Synonyms:** V-Ray Renderer

### ZBrush
- **Slug:** `zbrush`
- **Synonyms:** Pixologic ZBrush
- **Alternatives:**
  - `blender` (similar)
...
### FL Studio
- **Slug:** `fl-studio`
- **Synonyms:** FruityLoops, Fruity Loops
- **Alternatives:**
  - `ableton-live` (similar)
...
- **Synonyms:** Lightroom, LR, Lightroom Classic

### Capture One
- **Slug:** `capture-one`
- **Synonyms:** Capture One Pro
- **Alternatives:**
  - `adobe-lightroom` (similar)
...
- **Synonyms:** Dreamweaver

### Adobe XD
- **Slug:** `adobe-xd`
- **Icon:** `logos:adobe-xd`
- **Synonyms:** XD, Adobe Experience Design
- **Alternatives:**
  - `figma` (similar)
  - `sketch` (similar)
...
- **Slug:** `invision`
- **Icon:** `logos:invision`
- **Synonyms:** InVision Studio, InVision App
